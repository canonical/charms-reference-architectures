...
| `network_spaces`                        | CIDRs of the existing AWS subnets assigned to the peer and client Juju spaces                                                                                                                     | <pre>object({<br/>  peers_cidr   = optional(string, "10.0.2.0/24")<br/>  clients_cidr = optional(string, "10.0.3.0/24")<br/>})</pre>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `{}`            | no         |
...
MongoDB on `deployments_peers_subnet` and Data Integrator on
`deployments_clients_subnet`.
...
The address should be in `10.0.3.0/24`.
