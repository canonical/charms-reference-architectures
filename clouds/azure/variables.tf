...
variable "AKS_NODE_VM_SIZE" {
  description = "VM size for the default AKS node pool. Choose a size with enough data-disk attachments for persistent workloads. Use Standard_D4s_v3 for smaller workloads"
  type        = string
