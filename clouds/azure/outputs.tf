...
output "infrastructure" {
  value = {
    ...
    deployments_peers_subnet_name   = azurerm_subnet.deployments_peers_subnet.name
    deployments_clients_subnet_name = azurerm_subnet.deployments_clients_subnet.name
